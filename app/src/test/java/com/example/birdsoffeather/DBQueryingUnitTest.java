...
public class DBQueryingUnitTest {
    ...
    public void addPersons() {
        ...
        courses.add(new Course(userID,"2021", "Fall", "CSE", "110", "Large (200)"));
        courses.add(new Course(userID,"2021", "Fall", "CSE", "10", "Tiny (20)"));
        courses.add(new Course(userID,"2021", "Fall", "CSE", "12", "Medium (112)"));
        ...
        courses.add(new Course(testIds.get(0),"2021", "Fall", "CSE", "110", "Large (200)"));
        courses.add(new Course(testIds.get(0),"2021", "Fall", "CSE", "10", "Tiny (20)"));
        courses.add(new Course(testIds.get(0),"2021", "Fall", "CSE", "12", "Medium (112)"));

        testPersons.add(new PersonWithCourses(new Person(testIds.get(0),"person 1",""), courses));

        courses = new ArrayList<>();
        courses.add(new Course(testIds.get(1),"2021", "Fall", "ECE", "110", "Tiny (20)"));
        courses.add(new Course(testIds.get(1),"2021", "Spring", "CSE", "10", "Tiny (20)"));
        courses.add(new Course(testIds.get(1),"2021", "Fall", "CSE", "12", "Medium (112)"));

        testPersons.add(new PersonWithCourses(new Person(testIds.get(1),"person 2",""), courses));

        courses = new ArrayList<>();
        courses.add(new Course(testIds.get(2),"2019", "Fall", "CSE", "110", "Huge (325)"));
        courses.add(new Course(testIds.get(2),"2021", "Fall", "CSE", "10", "Tiny (20)"));
        courses.add(new Course(testIds.get(2),"2021", "Fall", "CSE", "12", "Medium (112)"));

        testPersons.add(new PersonWithCourses(new Person(testIds.get(2),"person 3",""), courses));

        courses = new ArrayList<>();
        courses.add(new Course(testIds.get(3),"2019", "Spring", "MAE", "110", "Large (200)"));
        courses.add(new Course(testIds.get(3),"2020", "Fall", "ECE", "10", "Small (60)"));
        courses.add(new Course(testIds.get(3),"2015", "Spring", "MAE", "1", "Tiny (20)"));
