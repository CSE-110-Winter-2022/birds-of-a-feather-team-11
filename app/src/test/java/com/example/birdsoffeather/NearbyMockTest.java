...
public class NearbyMockTest {
    ...
    public void generatePersonTest() {
        ...
        testStringBuilder.append('\n');
        testStringBuilder.append("2021,FA,CSE,210,Large (200)");
        testStringBuilder.append('\n');
        testStringBuilder.append("2022,WI,CSE,110,Huge (325)");
        testStringBuilder.append('\n');
        testStringBuilder.append("2022,SP,CSE,110,Medium (112)");
        testStringBuilder.append('\n');
        ...
        courses.add(new Course("replace with UUID","2021","FA","CSE","210", "Large (200)"));
        courses.add(new Course("replace with UUID","2022","WI","CSE","110", "Huge (325)"));
        courses.add(new Course("replace with UUID","2022","SP","CSE","110", "Medium (112)"));
    ...
    public void invalidStringGeneratePersonTest() {
        ...
        testStringBuilder.append("https://lh3.googleusercontent.com/pw/AM-JKLXQ2ix4dg-PzLrPOSMOOy6M3PSUrijov9jCLXs4IGSTwN73B4kr-F6Nti_4KsiUU8LzDSGPSWNKnFdKIPqCQ2dFTRbARsW76pevHPBzc51nceZDZrMPmDfAYyI4XNOnPrZarGlLLUZW9wal6j-z9uA6WQ=w854-h924-no?authuser=0,,");
        testStringBuilder.append('\n');
        testStringBuilder.append("2021,FA,210,Large (200)");
        testStringBuilder.append('\n');
    ...
    public void generateDifferentPersonTest() {
        ...
        testStringBuilder.append("https://lh3.googleusercontent.com/pw/AM-JKLXQ2ix4dg-PzLrPOSMOOy6M3PSUrijov9jCLXs4IGSTwN73B4kr-F6Nti_4KsiUU8LzDSGPSWNKnFdKIPqCQ2dFTRbARsW76pevHPBzc51nceZDZrMPmDfAYyI4XNOnPrZarGlLLUZW9wal6j-z9uA6WQ=w854-h924-no?authuser=0,,,");
        testStringBuilder.append('\n');
        testStringBuilder.append("2021,FA,CSE,110,Large (200)");
        testStringBuilder.append('\n');
        testStringBuilder.append("2022,WI,CSE,210,Huge (325)");
        testStringBuilder.append('\n');
        testStringBuilder.append("2022,SP,CSE,110,Medium (112)");
        testStringBuilder.append('\n');
        ...
        List<Course> courses = new ArrayList<>();
        courses.add(new Course("replace with UUID","2021","FA","CSE","210", "Large (200)"));
        courses.add(new Course("replace with UUID","2022","WI","CSE","110", "Large (200)"));
        courses.add(new Course("replace with UUID","2022","SP","CSE","110", "Medium (112)"));
